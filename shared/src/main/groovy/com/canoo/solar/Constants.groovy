...
public class Constants {
   ...
   static class FilterConstants {
    ...
    public static final String HOLD_UPDATES = 'holdUpdates'
    public static final String TOTAL_NOMINAL = 'totalNominal'
    public static final String AVERAGE_KWH = 'avgavgkwh'
    public static final String TOTAL_KWH = 'totalavgkwh'
    public static final String TYPE_DISTRIBUTION = 'typeDistribution'
    public static final String TYPE_MOST = 'typeMost'
    public static final String CITY_DISTRIBUTION = 'cityDistribution'
    public static final String CITY_MOST = 'cityMost'
